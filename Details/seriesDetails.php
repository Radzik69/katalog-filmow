...
<body id="body">
    ...
    if (isset($_POST['seriesID'])) {
        ...
        curl_setopt_array($curlCredits, [
            CURLOPT_URL => "https://api.themoviedb.org/3/tv/$seriesID/credits?language=en-US",
            CURLOPT_RETURNTRANSFER => true,
    ...
    <div id="top">
        ...
        ";
                ...
                if (isset($_POST["seriesID"]) && isset($_POST["userId"]) && isset($_POST["watchlistSubmit"])) {
                    $server = "localhost";
                    $dbuser = "root";
                    $dbpassword = "";
                    ...
                    $sql = "INSERT INTO `watchlist`(`userID`, `seriesID`) VALUES ('$_POST[userId]','$_POST[seriesID]')";
